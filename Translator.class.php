...
class Translator
{
	...
	private $_en_string;
	private $_letters = array('ا' => 'a','ب' => 'b', 'ت' => 't', 'و'=>'o','ـ'=>'','ث' => 'th', 'ج' => 'g', 'ح' => 'h', 'خ' => 'kh', 'د' => 'd', 'ذ' => 'z', 'ص' => 'sa',  'ض' => 'da', 'ع' => 'e', 'غ' => 'g', 'ف' => 'f', 'ق' => 'k', 'ط' => 'ta','ظ' => 'za', 'م' => 'm', 'ك' => 'k', 'س' => 's', 'ش' => 'sh', 'ﻻ' => 'la', 'ي'=>'e','ى' => 'y', 'ل' => 'l', 'ة' => 't', 'ه' => 'h', 'ؤ' => 'oa', 'ئ' => 'eo', 'ن' => 'n', 'ز' => 'z', 'ر' => 'r', ' '=> ' ');
